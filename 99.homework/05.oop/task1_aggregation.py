# при использовании агрегации в примере ниже, создаются циклические ссылки вида
...
# разрывает зацикливание и удаляет объекты.
#
# В целом это не является проблемой, но для практики и понимания проблемы нужно
# сделать рефакторинг кода, что бы:
#  - логика сохранилась: Device/BGP остались и BGP был частью Device,
#     т.е. оставляем композицию
...
#     как сейчас
#  - поможет решить задачу модуль weakref + WeakSet из него
