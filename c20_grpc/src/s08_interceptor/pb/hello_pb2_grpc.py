...
def add_HelloServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("app.hello.v1.HelloService", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("app.hello.v1.HelloService", rpc_method_handlers)
