...
def generate_asa_log():
    log_types = [
        ...
        ("%ASA-6-302013", "Built outbound TCP connection {} for outside:192.0.2.{}/{} to inside:10.1.2.{}/{}"),
        ("%ASA-6-305011", "Built dynamic TCP translation from inside:192.168.{}.{}/{} to outside:192.0.0.{}/{}"),
        (
            "%ASA-4-106023",
